...
public class SinhVienController {
	...
	public ModelAndView save(@ModelAttribute("emp") SinhVien sv) {
		dao.save(sv);
		return new ModelAndView("redirect:/viewAll");// will redirect to viewemp request mapping
	}
	...
	public ModelAndView updateSave(@ModelAttribute("sv") SinhVien sv) {
		dao.update(sv);
