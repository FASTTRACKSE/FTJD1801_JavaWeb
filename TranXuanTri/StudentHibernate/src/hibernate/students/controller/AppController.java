package hibernate.students.controller;
...
import hibernate.students.service.StudentService;
...
public class AppController {
	...
	public String saveEmployee(@Valid Student student, BindingResult result, ModelMap model,
		...
		if (!service.isStudentIdUnique(student.getId())) {
			FieldError idError = new FieldError("student", "id", message.getMessage("non.unique.id",
					new String[] { String.valueOf(student.getId()) }, Locale.getDefault()));
