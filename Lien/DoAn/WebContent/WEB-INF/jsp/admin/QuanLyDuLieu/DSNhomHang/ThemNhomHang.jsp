	...
	<div style="margin: 100px 50px;">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0">Thêm mới nhóm hàng</h3>
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a
								href='<c:url value="/Admin/QuanLyDuLieu/NhomHang" />'>Danh
									sách nhóm hàng</a></li>
							<li class="breadcrumb-item active">Thêm mới nhóm hàng</li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="main-content">
				<div class="row">
					<form:form method="POST" modelAttribute="nhomHang" action="">
						<form:input type="hidden" path="maNhom" id="maNhom" />
						<div class="form-group col-sm-4">
							<label>Tên nhóm sản phẩm</label>
							<form:input class="form-control" path="tenNhom"
								placeholder="tên nhóm sản phẩm" required="required" />
						</div>
						<div class="form-group col-sm-12">
							<label>Ghi chú</label>
							<form:textarea class="form-control" path="ghiChu"
								placeholder="chú thích" required="required" />
						</div>
