			...
			<div class="main-content">
				<div class="row">
					<form:form method="POST" enctype="multipart/form-data"
						modelAttribute="employeeProfile" action="">
						...
						<div class="form-group col-sm-4">
							...
							<form:input type="date" class="form-control"
								value="${employeeProfile.dayOfBirth}" path="dayOfBirth"
						...
						<div class="form-group col-sm-6">
							...
							<form:textarea class="form-control" path="introduction"
						...
						<div class="form-group col-sm-3">
							...
							<form:input class="form-control" path="dayOfRest"
						...
						<div class="form-group col-sm-4">
							<label>Bộ phận</label> <select id="phongBan" name="phongBan">
						...
						<div class="form-group col-sm-4">
							<label>Quyền hạn</label> <select id="chucDanh" name="chucDanh">
						...
						<div class="form-group col-sm-4">
							<label>Avatar</label> <input type="file" name="file"
