							...
							<div class="card-block card-dashboard">
								<div class="table-responsive">
									<table id="datatable"
										...
										<c:forEach var="tempKhachHang" items="${KhachHang}">
											<tr>
												<td>${tempKhachHang.maKhachHang}</td>
										...
										<ul class="pagination">
											<c:if test="${crPage != 1}">
												<li class="page-item"><a class="page-link"
													href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/1">Trang
														đầu</a></li>
												<li class="page-item"><a class="page-link"
													href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage-1}">Trang
														trước</a></li>
											</c:if>
											...
											<c:choose>
													...
													<c:choose>
														<c:when test="${totalPage gt 2}">
															<li class="page-item active"><a class="page-link"
																href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage}">${crPage}</a></li>
															<li class="page-item"><a class="page-link"
																href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage+1}">${crPage+1}</a></li>
															<li class="page-item"><a class="page-link"
																href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage+2}">${crPage+2}</a>
														</c:when>
												...
												<c:when test="${crPage eq totalPage}">
													<c:choose>
														<c:when test="${totalPage gt 2}">
															<li class="page-item"><a class="page-link"
																href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage-2}">${crPage-2}</a></li>
															<li class="page-item"><a class="page-link"
																href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage-1}">${crPage-1}</a></li>
															<li class="page-item active"><a class="page-link"
																href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage}">${crPage}</a>
														</c:when>
														<c:when test="${totalPage gt 1}">
															<li class="page-item"><a class="page-link"
																href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage-1}">${crPage-1}</a></li>
											...
											<c:if test="${crPage lt totalPage}">
												<li class="page-item"><a class="page-link"
													href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${crPage+1}">Trang
														sau</a></li>
												<li class="page-item"><a class="page-link"
													href="/DoAn/Admin/QuanLyDuLieu/KhachHang/list/${totalPage}">Trang
														cuối</a></li>
											</c:if>
										</ul>
									</c:if>
