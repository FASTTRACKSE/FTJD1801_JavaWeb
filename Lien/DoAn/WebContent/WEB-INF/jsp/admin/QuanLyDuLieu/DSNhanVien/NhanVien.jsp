				...
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						...
						<a class="btn btn-info"
							href="<c:url value='/Admin/QuanLyDuLieu/NhanVien/them' />">Thêm
							nhân viên <i class="fa fa-plus"></i>
						</a> <a class="btn btn-info"
							href="<c:url value='/Admin/QuanLyDuLieu/NhanVien' />">Tất cả
						</a>
						<div style="width: 400px;">
							<form action="/DoAn/Admin/QuanLyDuLieu/NhanVien/search"
						...
						<div class="card-body collapse in">
							<div class="card-block card-dashboard">
								<div class="table-responsive">
										...
										<c:forEach var="tempNhanVien" items="${NhanVien}">
											<tr>
												...
												<td><a
													...
													href="<c:url value='/Admin/QuanLyDuLieu/NhanVien/sua/${tempNhanVien.maNhanVien}' />"><i
														class="fa fa-edit"></i></a> <a
													href="<c:url value='/Admin/QuanLyDuLieu/NhanVien/xoa/${tempNhanVien.maNhanVien}' />">
									...
									<c:if test="${NhanVien eq null }">
										<h1>Không tìm thấy đối tượng này!!!</h1>
									</c:if>
								</div>
							</div>
						</div>
