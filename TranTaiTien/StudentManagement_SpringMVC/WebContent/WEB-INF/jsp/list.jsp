				...
				<c:choose>
						...
						<c:choose>
							<c:when test="${totalPage gt 2}">
								<li class="page-item active"><a class="page-link"
									href="/StudentManagement_SpringMVC/paging/${crPage}">${crPage}</a></li>
								<li class="page-item"><a class="page-link"
									href="/StudentManagement_SpringMVC/paging/${crPage+1}">${crPage+1}</a></li>
								<li class="page-item"><a class="page-link"
									href="/StudentManagement_SpringMVC/paging/${crPage+2}">${crPage+2}</a>
							</c:when>
					...
					<c:when test="${crPage eq totalPage}">
						<c:choose>
							<c:when test="${totalPage gt 2}">
								<li class="page-item"><a class="page-link"
									href="/StudentManagement_SpringMVC/paging/${crPage-2}">${crPage-2}</a></li>
								<li class="page-item"><a class="page-link"
									href="/StudentManagement_SpringMVC/paging/${crPage-1}">${crPage-1}</a></li>
								<li class="page-item active"><a class="page-link"
									href="/StudentManagement_SpringMVC/paging/${crPage}">${crPage}</a>
							</c:when>
							<c:when test="${totalPage gt 1}">
								<li class="page-item"><a class="page-link"
									href="/StudentManagement_SpringMVC/paging/${crPage-1}">${crPage-1}</a></li>
