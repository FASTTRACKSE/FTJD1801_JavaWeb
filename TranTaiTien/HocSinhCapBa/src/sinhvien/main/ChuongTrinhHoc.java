...
public class ChuongTrinhHoc {
	...
	public static void main(String[] args) {
		...
		System.out.println(" - Học: "+hocSinh.getMonHoc().getTenMonHoc()+ " - Giáo viên: "+hocSinh.getMonHoc().getGiaoVien());
		hocSinh.setMonHoc(new MonAnh());
		System.out.println("      : "+hocSinh.getMonHoc().getTenMonHoc()+ " - Giáo viên: "+hocSinh.getMonHoc().getGiaoVien());
