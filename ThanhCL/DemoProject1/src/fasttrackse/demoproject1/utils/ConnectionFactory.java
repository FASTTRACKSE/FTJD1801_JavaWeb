package fasttrackse.demoproject1.utils;
...
public class ConnectionFactory {
	String url = "jdbc:mysql://localhost/ftjd1801?useUnicode=true&characterEncoding=utf-8";
	String user = "ftjd1801";
	String password = "ftjd1801";
